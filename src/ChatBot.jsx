        ...
        messages: [
          {
            role: 'system',
            content:
              "You are a helpful assistant specialized in pet care. Only answer questions related to pet care, such as animal health, nutrition, grooming, training, and behavior. If a question is unrelated to pet care, respond with 'I can only answer questions related to pet care.' Additionally, always remind users that your responses are for general information only and do not constitute professional veterinary, medical, or legal advice.",
          },
  ...
  return (
    <>
      ...
      <div style={styles.wrapper}>
        <div style={{ color: '#9ca3af', fontSize: '14px', marginBottom: '12px', textAlign: 'center' }}>
          Please note: Zoomie AI provides general information only. It is not a substitute for professional veterinary, medical, or legal advice. Always consult a qualified expert for specific concerns.
        </div>
              ...
              {m.role === 'user' ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <img
                    ...
                    src={user?.imageUrl || 'https://cdn-icons-png.flaticon.com/512/147/147144.png'}
                    alt="User"
                    style={styles.avatar}
                  />
                </div>
...
const styles = {
  ...
  user: {
    alignSelf: 'flex-end',
    // background removed per instructions
    color: '#111827',
  },
  bot: {
